...
def add(request):
    ...
    if request.method == "POST":
        ...
        if not answer:
            ...
            color = 'warning'
            return render(request, 'divide.html', {'answer': answer, 'my_answer': my_answer, 'num_1': num_1, 'num_2': num_2, 'color': color})
...
def subtract(request):
    ...
    if request.method == "POST":
        ...
        return render(request, 'subtract.html', {'answer': answer, 'my_answer': my_answer, 'num_1': num_1, 'num_2': num_2, 'color': color})
...
def multiply(request):
    ...
    if request.method == "POST":
        ...
        return render(request, 'multiply.html', {'answer': answer, 'my_answer': my_answer, 'num_1': num_1, 'num_2': num_2, 'color': color})
